...
<div class="container">
  <form action="/action_page.php">
    ...
    <select id="course" name="course">
      ...
      <option value="dimplma in computer engineering">Diploma in Computer Engineering</option>
    
      <option value="Diploma in Mechanical Engineering">Diploma in Mechanical Engineering</option>
    
      <option value="Diploma in Civil Engineering">Diploma in Civil Engineering</option>
      <option value="Diploma in Mechatronics Engineeringg">Diploma in Mechatronics Engineering</option>
      <option value="Diploma in E&TC Engineering">Diploma in E&TC Engineering</option>
