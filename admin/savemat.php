<?php
	...
	if($crud == 'Save'){
		$sql="insert into tblmaterial(department,year,date,subject,description,fileupload,creator)
		Values('$department','$year', '$date','$subject','$description', '$fileupload','$creator')";
		...
		$sql="update  tblmaterial set department='$department', year='$year',
		date='$ddate', subject='$subject',description='$description',
		fileupload='$fileupload', creator='$creator' where id='$id'";
		mysqli_query($con,$sql);
