...
?>
	<table id="dttable1" class="table table-bordered table-hover">
		<thead>
			<tr style='background-color:#3c8dbc;color:white;'>
				...
				<th class="text-center">fileupload</th>
		...
		<?php
			...
			while($row = mysqli_fetch_assoc($res)){
				...
				<tr>
					...
					<td class='text-center'>
						<img src="<?php echo $row['fileupload']; ?>" class="img img-responsive" width="100px" height="50px">
					</td>
