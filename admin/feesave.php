<?php
	...
	if($crud == 'Save'){
		$sql="insert into tblfees ( dept, year, fees, descr, insertime, updatetime ) Values( '$dept','$year', '$fees','$descr', '$inertime', '$updatetime')";
		...
		$sql="update tblfees set dept='$dept',year='$year', fees='$fees', descr='$descr', insertime='$insertime', updatetime='$updatetime' where id='$id'";
		mysqli_query($con,$sql);
		...
		unlink($imgdata);
		$sql = "delete from tblfees where id='$id'";
